        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventAddress = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    EventDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EventNoOfVolunteers = table.Column<int>(type: "INTEGER", nullable: false),
                    EventLongitude = table.Column<double>(type: "REAL", nullable: true),
                    EventLatitude = table.Column<double>(type: "REAL", nullable: true),
                    EventApproval = table.Column<bool>(type: "INTEGER", nullable: false),
                    EventAssociationId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
